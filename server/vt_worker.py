    ...
    async def enrich_event(
        ...
        async with self.semaphore:
            ...
            if result:
                ...
                logger.info(f"VT enriched {sha256[:8]}... : {result.status} ({result.malicious} malicious)")
            else:
            ...
            async with httpx.AsyncClient(timeout=10) as client:
                ...
                if response.status_code == 200:
                    ...
                    return VTResult(
                        ...
                        total=analysis.get("undetected", 0) + analysis.get("malicious", 0) + analysis.get("suspicious", 0),
